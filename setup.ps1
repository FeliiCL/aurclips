...
Write-Host "  1. Edita config.yaml (canales, hora de publicacion, etc.)"
...
Write-Host "  4. Automatiza:     powershell -File setup_task.ps1"
Write-Host ""
Write-Host "(Opcional) Si instalas Ollama, el bot lo detecta y lo usa para"
Write-Host "escribir mejores titulos - sigue siendo 100% local y gratis."
